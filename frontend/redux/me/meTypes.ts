...
export type MeAction = {
    type: 'SET_ME' | 'SET_ME_UPDATING' | 'SET_ME_DISPLAY' | 'SET_ME_ITEM' | 'SET_ME_ITEMS' | 'REMOVE_ME_ITEM' | 'SET_ME_COLOR' | 'SET_ME_AVATAR' | 'SET_ME_BANNER',
    payload: any
}
...
export const SET_ME_DISPLAY = 'SET_ME_DISPLAY';
export const SET_ME_ITEM = 'SET_ME_ITEM';
